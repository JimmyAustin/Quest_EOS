...
import {Navbar, Nav, MenuItem, NavItem, NavDropdown, Panel, PanelGroup, Grid, Button, ButtonToolbar} from 'react-bootstrap';
...
<Panel >
    ...
    <Panel.Body><img src={x.image_url}></img></Panel.Body>
    <Panel.Body>
